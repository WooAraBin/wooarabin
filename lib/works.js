...
export const works = [
  {
    ...
    gallery: [
      { src: '/works/lenz.png', caption: '실시간 시세 브리핑' },
    ],
  },
  {
    slug: 'meetlog',
    ...
    gallery: [
      { src: '/works/meetlog.png', caption: '회의록 자동 정리' },
    ],
  },
  {
    slug: 'misikrok',
    ...
    gallery: [
      { src: '/works/misikrok.png', caption: '맛집 아카이브 메인' },
    ],
  },
  {
    slug: 'quicknote',
    ...
    gallery: [
      { src: '/works/quicknote.png', caption: '퀵 캡처 화면' },
    ],
  },
]
